...
describe('Редьюсер пользователя()', () => {
  it('устанавливает текущего пользователя при loginSuccess', () => {
  ...
  it('очищает текущего пользователя при logoutSuccess', () => {
...
describe('Эффекты пользователя', () => {
  ...
  it('login$ эмитит loginSuccess с пользователем и сохраняет пользователя в localStorage', async () => {
  ...
  it('login$ эмитит loginSuccess с null и очищает localStorage для неизвестного пользователя', async () => {
  ...
  it('logout$ эмитит logoutSuccess и удаляет currentUser при наличии', async () => {
  ...
  it('restoreSession$ ничего не эмитит, когда currentUser отсутствует в localStorage', () => {
    const effects = createEffects();
    const emitted: any[] = [];
  ...
  it('restoreSession$ эмитит loginSuccess для валидного сохраненного пользователя', () => {
  ...
  it('restoreSession$ эмитит logoutSuccess и очищает localStorage для неизвестного сохраненного пользователя', () => {
    localStorage.setItem(
      'currentUser',
